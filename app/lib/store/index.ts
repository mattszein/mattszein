...
import { WorkspaceSlice, createWorkspaceSlice } from "./slices/workspace";

export type Store = NeovimTreeSlice & NeovimSlice & WindowSlice & WorkspaceSlice;
...
export const createAppStore = (initState: Partial<StoreState> = defaultState) => {
  return createStore<Store>()((set, get, store) => ({
    ...
    ...createWorkspaceSlice(initState)(set, get, store)
  }));
};
